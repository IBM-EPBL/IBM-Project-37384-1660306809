...
def predict():
	...
	print("hello")
	response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/250158a7-805d-4e74-aecf-920a293e52e7/predictions?version=2022-11-18', json=payload_scoring,
